...
"""
__author__ = "Koustubh Sudarshan, Alex Karavos, Siamak Salavatian, Olujimi Ajijola, Guy Kember"
__version__ = "1.0"
...
# In[ ]:
def plot_multiLevel1(x, region, plot_list, plot_level, plot_title, i) :
    # https://realpython.com/python-matplotlib-guide/
    # https://s3.amazonaws.com/assets.datacamp.com/blog_assets/Python_Matplotlib_Cheat_Sheet.pdf
    fig, ax = plt.subplots(figsize=(16,3), nrows = 3, ncols = 1)
    xleft = min(plot_list[1:50])
    xright = max(plot_list[1:50])
    plot_x = x[xleft : xright]
    ax[0].plot(plot_x, color='blue', linewidth=1)
    ax[1].plot(region[xleft : xright],  color='black', linewidth=1)
    ax[0].grid(axis='y')
    ax[1].grid(axis='y')
    ax[2].scatter(plot_list[1:50],plot_level[1:50],color='darkred',marker='.',s=50)
    ax[2].set_ylim([0,40])
    ax[0].set_title(plot_title)
    #ax.set_xlim(3120000, 3140000)
    plt.savefig(plot_title + '_' + str(i) + '.png')
    #plt.show
...
def analysisLevelGetSpike(\
    ...
    if verbose_plot :
        ...
        plot_title = 'getSpikeLevel_resetLOCATION_REGION'
        plot_multiLevel1(x, region=region, plot_list=plot_list, plot_level=plot_level, plot_title=plot_title, i = number_of_levels) 
    ...
    if verbose_plot :
        ...
        plot_list = np.nonzero(np.abs(location - level) < 0.0001)[0]
        plot_level = x[plot_list]
        plot_title = 'getCLeanedUp_reset_REGION'
        plot_multiLevel1(x, region=region, plot_list=plot_list, plot_level=plot_level, plot_title=plot_title, i = number_of_levels) 
    #############################################
    ...
    if verbose_plot :
        ...
        plot_level = x[plot_list]
        plot_title = 'getRingingCLeanedUp_resetLOCATION_REGION_LOCATION_LIST_BUILT'
        plot_multiLevel1(x, region=region, plot_list=plot_list, plot_level=plot_level, plot_title=plot_title, i = number_of_levels) 
    ...
    if verbose_plot :
        ...
        plot_list = location_list
        plot_level = x[plot_list]
        plot_title = 'getRidOfIsland_resetREGION'
        plot_multiLevel1(x, region=region, plot_list=plot_list, plot_level=plot_level, plot_title=plot_title, i = number_of_levels) 
